      ...
      <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <div class="relative px-4 pt-6 sm:px-6 lg:px-8">
            <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
              <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                <div class="flex items-center justify-between w-full md:w-auto">
                  <a href="#">
                    ...
                    <img class="w-auto h-8 sm:h-14" src="~/static/gear2.svg">
                  </a>
              ...
              <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                ...
                <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Reviews</a>

                <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Company</a>

                <a href="#" class="font-medium text-blue-600 hover:text-blue-500">Contact us</a>
              </div>
            </nav>
          </div>
          ...
          <div v-show="false" class="absolute inset-x-0 top-0 z-10 p-2 transition origin-top-right transform md:hidden">
            <div class="overflow-hidden bg-white rounded-lg shadow-md ring-1 ring-black ring-opacity-5">
              ...
              <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="#" class="block px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:text-gray-900 hover:bg-gray-50">Reviews</a>
              ...
              <a href="#" class="block w-full px-5 py-3 font-medium text-center text-blue-600 bg-gray-50 hover:bg-gray-100"> Log in </a>
            </div>
          </div>
        </div>
        ...
        <main class="px-4 mx-auto mt-10 max-w-7xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div class="sm:text-center lg:text-left">
            <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 playfair sm:text-5xl md:text-6xl">

    ...
    <div class="flex items-center justify-between w-full px-4 py-2.5 mx-auto max-w-7xl sm:px-6">
      ...
      <div class="flex items-center space-x-4">
        ...
        <span class="flex items-center space-x-2 group">
          ...
          <a v-show="mapOpen" class="inline-block text-sm text-blue-100 md:hidden hover:text-blue-50" href="http://maps.google.com/maps?q=397+Wekiva+Springs+Road,+Longwood,+FL+32779" target="_blank">Wekiva Springs Rd</a>
        </span>
      </div>
    </div>
  </div>

    ...
    <div class="flex items-center justify-between w-full px-4 py-2.5 mx-auto max-w-7xl sm:px-6">
      ...
      <div class="flex items-center space-x-4">
        ...
        <span class="flex items-center space-x-2 group">
          ...
          <a class="hidden text-sm text-blue-100 md:inline-block hover:text-blue-50" href="http://maps.google.com/maps?q=397+Wekiva+Springs+Road+Suite+221,+Longwood,+FL+32779" target="_blank">397 Wekiva Springs Road, Suite 221</a>
          <a v-show="mapOpen" class="inline-block text-xs text-blue-100 md:hidden hover:text-blue-50" href="http://maps.google.com/maps?q=397+Wekiva+Springs+Road,+Longwood,+FL+32779" target="_blank">397 Wekiva Springs Rd, #221</a>
        </span>
      </div>
    </div>
  </div>

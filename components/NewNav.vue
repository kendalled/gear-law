        ...
        <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
          ...
          <nav class="hidden space-x-10 md:flex">
            <div class="relative">
              ...
              <button @click="servicesOpen = !servicesOpen" type="button" class="inline-flex items-center text-base font-medium text-gray-500 bg-white rounded-md group hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" aria-expanded="false">
                <span>Services</span>
                <!--
            ...
            <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Attorneys </a>
            <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900"> Results </a>

            <div class="relative">
              <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" -->
              <button type="button" @click.prevent="moreOpen = !moreOpen" class="inline-flex items-center text-base font-medium text-gray-500 bg-white rounded-md group hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" aria-expanded="false">
                <span>More</span>
                <!--
                Heroicon name: solid/chevron-down
        ...
        <div class="bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
          <div class="px-5 pt-5 pb-6">
            <div class="flex items-center justify-between">
              <div>
                <img class="w-auto h-8" src="~/static/gear2.svg" alt="Gear Law">
              </div>
              <div class="-mr-2">
          ...
          <div class="px-5 py-6 space-y-6">
            <div class="grid grid-cols-2 gap-y-4 gap-x-8">
              <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-700"> Attorneys </a>

<template>
  <svg
    ...
    x="0px"
    y="0px"
    class="z-50 w-full lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
    viewBox="0 0 884 832"
    style="enable-background:new 0 0 884 832;"
    xml:space="preserve"
  >
    <style type="text/css">
    ...
    <path
      class="st2"
      d="M221.3,159.7c-0.1,9.2-5.6,13.6-12.4,9.7c-6.8-3.8-12.2-14.4-12.1-23.6c0.1-9.2,5.6-13.6,12.4-9.7
  C216,139.9,221.4,150.5,221.3,159.7z"
    ...
    <path
      class="st2"
      d="M711.4,660.1c-0.1,9.2-5.6,13.6-12.4,9.7c-6.8-3.8-12.2-14.4-12.1-23.6c0.1-9.2,5.6-13.6,12.4-9.7
  C706.1,640.3,711.5,650.9,711.4,660.1z"
    ...
    <path
      class="st4"
      d="M632.1,4.7c-40.6,7.9-131.9,18.1-171.7-4.4c0.3,159.2,39.3,385.1,166.8,571.4c129.5-40.9,172-220.6,175-377.9
  C762.4,171.2,672.2,58.3,632.1,4.7z"
    ...
    <path
      id="bouncer"
      class="st5 bounce"
      d="M582.5,37.7c-40.6,7.9-131.9,18.1-171.7-4.4c0.3,159.2,39.3,385.1,166.8,571.4c129.5-40.9,172-220.7,175-377.9
  C712.8,204.2,622.6,91.3,582.5,37.7z"
    ...
    <path id="bouncer2" class="st6 bounce" d="M752.7,226.7c-39.9-22.6-130-135.4-170.1-189l-4.9,566.9C707.1,563.8,749.6,384,752.7,226.7z" />
    <linearGradient
      id="SVGID_6_"
      gradientUnits="userSpaceOnUse"
      x1="367.1988"
    ...
    <path
      class="st10"
      d="M416.2,398.4c0,9.6-5.7,14.3-12.7,10.4s-12.8-14.8-12.8-24.5c0-9.6,5.7-14.3,12.7-10.4
  C410.5,377.8,416.2,388.8,416.2,398.4z"
    ...
    <path
      class="st13"
      d="M234,481.2c6,3.4,10.8,11.8,10.8,18.7v30.5L265,542c6,3.4,10.8,11.8,10.8,18.7s-4.8,9.7-10.8,6.3l-20.2-11.6

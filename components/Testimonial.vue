<template>
  <!-- Testimonial section -->
  <div class="pb-16 bg-gradient-to-r from-blue-700 to-blue-900 lg:pb-0 lg:z-10 lg:relative">
          ...
          <blockquote>
            <div>
              ...
              <p class="mt-6 text-2xl font-medium text-white">
                I was involved in a serious car accident and my attorney Justin Eisele was a godsend. [...] He was extremely professional in every way. He always returned my calls and answered all my questions.
              </p>
            </div>
            <footer class="mt-6">

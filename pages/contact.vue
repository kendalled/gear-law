        ...
        <nav class="relative flex items-center justify-between px-6 pt-6 mx-auto max-w-7xl xl:px-8" aria-label="Global">
          <div class="flex items-center flex-1">
            ...
            <div class="hidden space-x-10 lg:flex lg:ml-10">
              <a href="#" class="text-base font-medium text-warm-gray-500 hover:text-warm-gray-900">Changelog</a>
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="relative bg-white shadow-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
              <!-- Contact information -->
              <div class="relative px-6 py-10 overflow-hidden bg-gradient-to-b from-blue-500 to-blue-600 sm:px-10 xl:p-12">
              ...
              <div class="px-6 py-10 sm:px-10 lg:col-span-2 xl:p-12">
                ...
                <form action="#" method="POST" class="grid grid-cols-1 mt-6 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                  <div>
                    ...
                    <div class="mt-1">
                      <input id="first-name" type="text" name="first-name" autocomplete="given-name" class="block w-full px-4 py-3 rounded-md shadow-sm text-warm-gray-900 focus:ring-blue-500 focus:border-blue-500 border-warm-gray-300">
                    </div>
                  </div>
                  <div>
                    <label for="last-name" class="block text-sm font-medium text-warm-gray-900">Last name</label>
                    <div class="mt-1">
                      <input id="last-name" type="text" name="last-name" autocomplete="family-name" class="block w-full px-4 py-3 rounded-md shadow-sm text-warm-gray-900 focus:ring-blue-500 focus:border-blue-500 border-warm-gray-300">
                    </div>
                  </div>
                  <div>
                    <label for="email" class="block text-sm font-medium text-warm-gray-900">Email</label>
                    <div class="mt-1">
                      <input id="email" name="email" type="email" autocomplete="email" class="block w-full px-4 py-3 rounded-md shadow-sm text-warm-gray-900 focus:ring-blue-500 focus:border-blue-500 border-warm-gray-300">
                    </div>
                  </div>
                  <div>
                    ...
                    <div class="mt-1">
                      <input
                        ...
                        name="phone"
                        autocomplete="tel"
                        class="block w-full px-4 py-3 rounded-md shadow-sm text-warm-gray-900 focus:ring-blue-500 focus:border-blue-500 border-warm-gray-300"
                  ...
                  <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                      <input id="subject" type="text" name="subject" class="block w-full px-4 py-3 rounded-md shadow-sm text-warm-gray-900 focus:ring-blue-500 focus:border-blue-500 border-warm-gray-300">
                    </div>
                  </div>
                  <div class="sm:col-span-2">
                    <div class="flex justify-between">
                    ...
                    <div class="mt-1">
                      <textarea id="message" name="message" rows="4" class="block w-full px-4 py-3 border rounded-md shadow-sm text-warm-gray-900 focus:ring-blue-500 focus:border-blue-500 border-warm-gray-300" aria-describedby="message-max" />
                    </div>
                  </div>
                  <div class="sm:col-span-2 sm:flex sm:justify-end">
                    <button type="submit" class="inline-flex items-center justify-center w-full px-6 py-3 mt-2 text-base font-medium text-white bg-blue-500 border border-transparent rounded-md shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:w-auto">
                      Submit
                    </button>
                  </div>
                </form>
        ...
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div class="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-sm font-semibold tracking-wider uppercase text-warm-gray-200">
                  Solutions
                </h3>

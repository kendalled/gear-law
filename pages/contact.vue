  ...
  <div class="bg-white">
    <header class="relative z-10">
      <div class="bg-gray-50">
        <nav class="relative flex items-center justify-between px-6 pt-8 mx-auto max-w-7xl xl:px-8" aria-label="Global">
          ...
          <div class="hidden lg:flex lg:items-center lg:space-x-6">
            <a href="#" class="px-6 py-2 text-base font-medium text-blue-600 bg-white border border-transparent rounded-md shadow-md hover:bg-gray-50"> Contact us </a>
          </div>
        </nav>
      </div>
    ...
    -->
      <div v-show="false" class="absolute inset-x-0 top-0 p-2 transition origin-top transform lg:hidden">
        <div class="overflow-hidden bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
          ...
          <div class="pt-5 pb-6">
            <div class="px-2 space-y-1">
              <a href="#" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-50">Work</a>

              <a href="#" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-50">Services</a>

              <a href="#" class="block px-3 py-2 text-base font-medium text-gray-900 rounded-md hover:bg-gray-50">About</a>
    ...
    <main>
      ...
      <div class="py-24 bg-gray-50 sm:py-32">
        <div class="max-w-md pl-4 pr-8 mx-auto sm:max-w-lg sm:px-6 lg:max-w-7xl lg:px-8">
          <h1 class="text-4xl font-extrabold leading-10 tracking-tight text-center text-gray-900 sm:text-5xl sm:leading-none lg:text-6xl">
            Get in touch
          </h1>
          <p class="max-w-3xl mx-auto mt-6 text-xl leading-normal text-center text-gray-500">
      ...
      <div class="relative bg-white">
        ...
        <div class="relative px-4 py-16 sm:py-24 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:py-32 lg:grid lg:grid-cols-2">
          <div class="lg:pr-8">
    ...
    <footer class="bg-gray-900" aria-labelledby="footer-heading">
      ...
      <div class="max-w-md px-4 py-12 mx-auto sm:max-w-lg sm:pt-16 sm:px-6 lg:max-w-7xl lg:pt-24 lg:pb-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-8 xl:col-span-1">
            <img class="h-10" src="~/static/gear2.svg" alt="Company name">
        ...
        <div class="pt-8 mt-12 border-t border-gray-700">
          <p class="text-base text-gray-400 xl:text-center">
            &copy; 2022 Gagnon, Eisele, and Rigby PLLC. All rights reserved.
          </p>
        </div>
      </div>
    </footer>

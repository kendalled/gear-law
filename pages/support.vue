  ...
  <div class="min-h-screen bg-white">
    <header class="relative pb-36 bg-blue-gray-800">
      <div class="absolute inset-0">
        <img class="object-cover w-full h-full" src="https://images.unsplash.com/photo-1560574188-6a6774965120?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&q=60&&sat=-100" alt="">
        <div class="absolute inset-0 bg-blue-gray-800 mix-blend-multiply" aria-hidden="true" />
      </div>
      <div class="relative z-10">
        <nav class="relative flex items-center justify-between px-4 pt-6 pb-2 mx-auto max-w-7xl sm:px-6 lg:px-8" aria-label="Global">
          <div class="flex items-center flex-1">
            <div class="flex items-center justify-between w-full lg:w-auto">
              <nuxt-link to="/" title="Home Page">
                <span class="sr-only">Gear Law</span>
                <img class="w-auto h-8 sm:h-10" src="~/static/logo.png" alt="">
              </nuxt-link>
              <div class="flex items-center -mr-2 lg:hidden">
                <button type="button" class="inline-flex items-center justify-center p-2 text-white bg-opacity-0 rounded-md bg-blue-gray-900 hover:bg-opacity-100 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white" aria-expanded="false">
          ...
          <div class="hidden lg:flex lg:items-center lg:space-x-6">
            <a href="#" class="px-6 py-2 text-base font-medium text-white bg-blue-500 border border-transparent rounded-md shadow-md hover:bg-blue-600">
              Get Started
            </a>
          </div>
        </nav>
        ...
        <div class="absolute inset-x-0 top-0 p-2 transition origin-top transform lg:hidden">
          <div class="overflow-hidden bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
            <div class="flex items-center justify-between px-5 pt-4">
              ...
              <div class="-mr-2">
                <button type="button" class="inline-flex items-center justify-center p-2 bg-white rounded-md text-blue-gray-400 hover:bg-blue-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500">
            ...
            <div class="pt-5 pb-6">
              <div class="px-2 space-y-1">
                <a href="#" class="block px-3 py-2 text-base font-medium rounded-md text-blue-gray-900 hover:bg-blue-gray-50">Changelog</a>

                <a href="#" class="block px-3 py-2 text-base font-medium rounded-md text-blue-gray-900 hover:bg-blue-gray-50">About</a>

                <a href="#" class="block px-3 py-2 text-base font-medium rounded-md text-blue-gray-900 hover:bg-blue-gray-50">Partners</a>

                <a href="#" class="block px-3 py-2 text-base font-medium rounded-md text-blue-gray-900 hover:bg-blue-gray-50">News</a>
              </div>
              <div class="px-5 mt-6">
      ...
      <div class="relative max-w-md px-4 pb-32 mx-auto mt-24 sm:max-w-3xl sm:px-6 md:mt-32 lg:max-w-7xl lg:px-8">
        ...
        <p class="max-w-3xl mt-6 text-xl text-blue-gray-300">
    ...
    <main>
      <div class="bg-blue-gray-50">
        <!-- Cards -->
        <section class="relative z-10 max-w-md px-4 mx-auto -mt-32 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8" aria-labelledby="contact-heading">
          ...
          <div class="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
            <div class="flex flex-col bg-white shadow-xl rounded-2xl">
              <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
                ...
                <h3 class="text-xl font-medium text-blue-gray-900">
                  Sales
                </h3>
        ...
        <!-- FAQ -->
        <section class="max-w-md px-4 py-24 mx-auto divide-y-2 divide-blue-gray-200 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:py-32 lg:px-8" aria-labelledby="faq-heading">
          <h2 id="faq-heading" class="text-3xl font-extrabold text-blue-gray-900">
          ...
          <div class="lg:grid lg:grid-cols-12">
            <div class="relative z-10 lg:col-start-1 lg:row-start-1 lg:col-span-4 lg:py-16 lg:bg-transparent">
              ...
              <div class="max-w-md px-4 mx-auto sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0">
                <div class="aspect-w-10 aspect-h-6 sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1">
                  <img class="object-cover object-center shadow-2xl rounded-3xl" src="https://images.unsplash.com/photo-1507207611509-ec012433ff52?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=934&q=80" alt="">
                </div>
              </div>
            </div>
            ...
            <div class="relative bg-blue-600 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
              ...
              <div class="relative max-w-md px-4 py-12 mx-auto space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                ...
                <a class="block w-full px-5 py-3 text-base font-medium text-center text-blue-700 bg-white border border-transparent rounded-md shadow-md hover:bg-blue-gray-50 sm:inline-block sm:w-auto" href="#">Explore open positions</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- Newsletter Section -->
      <section class="max-w-md px-4 py-24 mx-auto sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:py-32 lg:px-8 lg:flex lg:items-center" aria-labelledby="newsletter-heading">
        <div class="lg:w-0 lg:flex-1">
          <h2 id="newsletter-heading" class="text-3xl font-extrabold text-blue-gray-900 sm:text-4xl">
        ...
        <div class="mt-8 lg:mt-0 lg:ml-8">
          <form class="sm:flex">
            ...
            <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button type="submit" class="flex items-center justify-center w-full px-5 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                Notify me
              </button>
            </div>
          </form>
